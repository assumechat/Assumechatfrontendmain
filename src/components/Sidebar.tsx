               ...
               <DrawerBody >
                <div className="fixed top-16 left-0 right-0 bg-white bg-opacity-95 backdrop-blur-lg z-40 md:hidden border-b border-gray-200">
                    <nav className="flex flex-col py-4 px-1 space-y-4">
                        <div className="bg-white border border-[#B30738] rounded-lg py-3 px-1  mr-14 flex items-center justify-between">
                        ...
                        <div className="space-y-1 py-2 px-0 mr-14 ">
                            {mainTabs.map((tab) => (
                                <Link
                                    key={tab.id}
                        ...
                        <hr className="my-2 border-gray-200 mr-14 " />
                        <div className="p-2">
                        ...
                        <div className="flex flex-col space-y-3 pt-2 mr-14 ">
                            {
                                isAuthenticated ? (
                                    <Link
                                        href="/"
